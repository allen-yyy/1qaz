...
void HariMain(void)
{
	...
	int fifobuf[128], keycmd_buf[32],intb[10];
	...
	fifo32_init(&int_fifo, 10, intb, 0);
	*((int *) 0x0fec) = (int) &fifo;
	init_pit();
	init_keyboard(&fifo, 256);
	enable_mouse(&fifo, 512, &mdec);
	io_out8(PIC0_IMR, 0xf8); /* PITとPIC1とキーボードを許可(11111000) */
	io_out8(PIC1_IMR, 0xaf); /* マウスを許可(10101111) */
